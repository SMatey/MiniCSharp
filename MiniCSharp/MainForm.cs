...
namespace MiniCSharp 
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            InitializeUiControls(); // Esto inicializa los botones, etc.

            // --- LÓGICA CORREGIDA ---
            // Simplemente abrimos una pestaña nueva y en blanco al iniciar.
            AddNewTab(); 

            // Esto es para que el layout se ajuste si cambia el tamaño de la ventana.
        ...
        private void BtnCompile_Click(object sender, EventArgs e)
        {
            ...
            if (!result.Success)
            {
                ...
                txtOutput.Text = "La compilación falló con los siguientes errores:\n\n";
